...
function startGame() {
    for (let r = 0; r < rows; r++) {
        ...
        for (let c = 0; c < columns; c++) {
            ...
            tile.addEventListener("dragover", dragOver);  //şekere tıklamak, şekeri sürüklemek için fareyi hareket ettirmek
            ...
            tile.addEventListener("drop", dragDrop); //bir şekeri başka bir şekerin üzerine düşürmek
...
function dragDrop() {
    //bu, üzerine bırakılan hedef karoyu ifade eder
    otherTile = this;
}
